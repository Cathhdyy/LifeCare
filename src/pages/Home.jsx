  ...
  const doctorsList = [
    ...
    },
    {
      ...
      stats: [
        ...
        { icon: Award, value: "BDS Qualified", label: "Dental Degree", color: "purple", colSpan: true }
      ]
    }
  ];
                    ...
                    <div className="relative group">
                      ...
                      <div className="relative">
                        ...
                        <input 
                          ...
                          className="w-full h-12 sm:h-14 pl-11 pr-4 bg-slate-50 rounded-xl border border-slate-200 focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 outline-none transition-all font-medium text-slate-700 relative text-sm block appearance-none" 
                        />
                      </div>
                    </div>

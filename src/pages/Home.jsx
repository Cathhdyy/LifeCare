  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-800 selection:bg-blue-200 selection:text-blue-900 overflow-x-hidden flex flex-col w-full">
      ...
      <main className="flex-grow w-full">
        ...
        {/* Quick Info Bar */}
        <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-8 sm:-mt-12 mb-12 sm:mb-16">
        ...
        <section id="services" className="py-12 md:py-32 bg-gradient-to-b from-white to-slate-50 relative overflow-hidden border-t border-slate-100">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 md:gap-8 mt-10 sm:mt-16">
              
              {/* Service Card 1 */}
              <div className="bg-white p-6 sm:p-8 md:p-10 rounded-[1.5rem] sm:rounded-[2rem] shadow-sm sm:shadow-md border border-slate-100 hover:border-blue-200 hover:shadow-xl hover:-translate-y-1 sm:hover:-translate-y-2 transition-all duration-500 group flex flex-col h-full relative overflow-hidden">
                ...
                <div className="flex-grow relative z-10">
                  <div className="w-14 h-14 sm:w-16 sm:h-16 md:w-20 md:h-20 rounded-xl sm:rounded-2xl flex items-center justify-center text-blue-600 bg-blue-50 mb-5 sm:mb-6 md:mb-8 group-hover:bg-blue-600 group-hover:text-white transition-all duration-500 shadow-sm group-hover:shadow-blue-500/30">
                    <div className="transform transition-transform duration-1000 group-hover:[transform:rotateY(360deg)] w-full h-full flex items-center justify-center">
                      <ShieldCheck className="w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 opacity-90 drop-shadow-sm group-hover:drop-shadow-md transition-all duration-500 group-hover:text-white" />
                    </div>
                  </div>
                  <h4 className="text-lg sm:text-xl md:text-2xl font-extrabold text-slate-900 mb-2 sm:mb-3 md:mb-4 group-hover:text-blue-600 transition-colors duration-300">General & Preventive Dentistry</h4>
                  <p className="text-slate-600 font-medium leading-relaxed text-xs sm:text-sm md:text-base">Comprehensive oral care focusing on preventing dental issues before they start.</p>
                </div>
                <a href="/services" className="mt-6 sm:mt-8 md:mt-10 pt-4 sm:pt-5 md:pt-6 border-t border-slate-100 flex items-center text-blue-600 font-bold group-hover:text-blue-700 transition-colors text-xs sm:text-sm md:text-base relative z-10 w-full text-left min-h-[40px] sm:min-h-[44px]">
                  Book this service <ArrowRight className="w-4 h-4 sm:w-4 sm:h-4 md:w-5 md:h-5 ml-1.5 sm:ml-2 transform group-hover:translate-x-1.5 transition-transform duration-300" />
                </a>
              </div>
              ...
              <div className="bg-white p-6 sm:p-8 md:p-10 rounded-[1.5rem] sm:rounded-[2rem] shadow-sm sm:shadow-md border border-slate-100 hover:border-blue-200 hover:shadow-xl hover:-translate-y-1 sm:hover:-translate-y-2 transition-all duration-500 group flex flex-col h-full relative overflow-hidden">
                ...
                <div className="flex-grow relative z-10">
                  <div className="w-14 h-14 sm:w-16 sm:h-16 md:w-20 md:h-20 rounded-xl sm:rounded-2xl flex items-center justify-center text-purple-600 bg-purple-50 mb-5 sm:mb-6 md:mb-8 group-hover:bg-purple-600 group-hover:text-white transition-all duration-500 shadow-sm group-hover:shadow-purple-500/30">
                    <div className="transform transition-transform duration-1000 group-hover:[transform:rotateY(360deg)] w-full h-full flex items-center justify-center">
                      <Stethoscope className="w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 opacity-90 drop-shadow-sm group-hover:drop-shadow-md transition-all duration-500 group-hover:text-white" />
                    </div>
                  </div>
                  <h4 className="text-lg sm:text-xl md:text-2xl font-extrabold text-slate-900 mb-2 sm:mb-3 md:mb-4 group-hover:text-blue-600 transition-colors duration-300">Root Canal Treatment</h4>
                  <p className="text-slate-600 font-medium leading-relaxed text-xs sm:text-sm md:text-base">Save heavily infected or damaged teeth with advanced, painless root canal therapy.</p>
                </div>
                <a href="/services" className="mt-6 sm:mt-8 md:mt-10 pt-4 sm:pt-5 md:pt-6 border-t border-slate-100 flex items-center text-blue-600 font-bold group-hover:text-blue-700 transition-colors text-xs sm:text-sm md:text-base relative z-10 w-full text-left min-h-[40px] sm:min-h-[44px]">
                  Book this service <ArrowRight className="w-4 h-4 sm:w-4 sm:h-4 md:w-5 md:h-5 ml-1.5 sm:ml-2 transform group-hover:translate-x-1.5 transition-transform duration-300" />
                </a>
              ...
              <div className="col-span-1 sm:col-span-2 lg:col-span-1 bg-white p-6 sm:p-8 md:p-10 rounded-[1.5rem] sm:rounded-[2rem] shadow-sm sm:shadow-md border border-slate-100 hover:border-blue-200 hover:shadow-xl hover:-translate-y-1 sm:hover:-translate-y-2 transition-all duration-500 group flex flex-col h-full relative overflow-hidden">
                ...
                <div className="flex-grow relative z-10">
                  <div className="w-14 h-14 sm:w-16 sm:h-16 md:w-20 md:h-20 rounded-xl sm:rounded-2xl flex items-center justify-center text-cyan-600 bg-cyan-50 mb-5 sm:mb-6 md:mb-8 group-hover:bg-cyan-600 group-hover:text-white transition-all duration-500 shadow-sm group-hover:shadow-cyan-500/30">
                    <div className="transform transition-transform duration-1000 group-hover:[transform:rotateY(360deg)] w-full h-full flex items-center justify-center">
                      <HeartHandshake className="w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 opacity-90 drop-shadow-sm group-hover:drop-shadow-md transition-all duration-500 group-hover:text-white" />
                    </div>
                  </div>
                  <h4 className="text-lg sm:text-xl md:text-2xl font-extrabold text-slate-900 mb-2 sm:mb-3 md:mb-4 group-hover:text-blue-600 transition-colors duration-300">Pediatric (Child) Dentistry</h4>
                  <p className="text-slate-600 font-medium leading-relaxed text-xs sm:text-sm md:text-base">Gentle, fear-free dental treatments tailored specifically for growing children.</p>
                </div>
                <a href="/services" className="mt-6 sm:mt-8 md:mt-10 pt-4 sm:pt-5 md:pt-6 border-t border-slate-100 flex items-center text-blue-600 font-bold group-hover:text-blue-700 transition-colors text-xs sm:text-sm md:text-base relative z-10 w-full text-left min-h-[40px] sm:min-h-[44px]">
                  Book this service <ArrowRight className="w-4 h-4 sm:w-4 sm:h-4 md:w-5 md:h-5 ml-1.5 sm:ml-2 transform group-hover:translate-x-1.5 transition-transform duration-300" />
                </a>
            ...
            <div className="flex justify-center mt-10 sm:mt-14 px-4 sm:px-0">
              <a 
                href="/services" 
        ...
        <section id="reviews" className="py-16 md:py-32 bg-white relative overflow-hidden border-t border-slate-100">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-7xl h-full pointer-events-none">
            <div className="absolute top-10 sm:top-20 right-0 w-48 h-48 sm:w-80 sm:h-80 bg-blue-50/50 rounded-full blur-[60px] sm:blur-[80px]"></div>
            <div className="absolute bottom-10 sm:bottom-20 left-0 w-48 h-48 sm:w-80 sm:h-80 bg-yellow-50/50 rounded-full blur-[60px] sm:blur-[80px]"></div>
          </div>

          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center max-w-3xl mx-auto mb-10 sm:mb-16 group cursor-default">
              <div className="inline-flex items-center bg-yellow-50 border border-yellow-200 text-yellow-700 px-4 py-1.5 sm:py-2 rounded-full text-[10px] sm:text-sm font-extrabold uppercase tracking-widest mb-4 sm:mb-6 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all">
                <Star className="w-3.5 h-3.5 sm:w-4 sm:h-4 fill-current mr-2 sm:mr-2.5" />
                Trusted by Our Patients
              </div>
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-slate-900 mb-4 sm:mb-6 leading-tight transition-transform duration-700 group-hover:scale-[1.02]">
                Highly Rated in <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-cyan-500">Singtam</span>
              </h2>
              <p className="text-sm sm:text-lg text-slate-600 font-medium mb-8 sm:mb-10 px-2 sm:px-0">
                Our clinic is highly rated by patients in Singtam for professional and comfortable dental care.
              </p>
            </div>

            {/* Rating Summary Card */}
            <div className="bg-white border border-slate-100 shadow-xl sm:shadow-[0_10px_30px_-10px_rgba(0,0,0,0.08)] rounded-3xl p-6 sm:p-8 max-w-sm sm:max-w-md mx-auto mb-12 sm:mb-16 flex flex-col items-center text-center transform hover:-translate-y-1 transition-all duration-500 cursor-default group w-full">
              <div className="flex items-center justify-center mb-3 sm:mb-4">
                <svg className="w-8 h-8 sm:w-10 sm:h-10 mr-3 sm:mr-4 group-hover:scale-110 transition-transform duration-500" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" fill="#4285F4"/>
                  <path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" fill="#34A853"/>
                  <path d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z" fill="#FBBC05"/>
                  <path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" fill="#EA4335"/>
                </svg>
                <div className="text-4xl sm:text-5xl font-black text-slate-900 tracking-tight">4.6<span className="text-xl sm:text-2xl text-slate-400 font-bold ml-1">/ 5</span></div>
              </div>
              <div className="flex gap-1.5 text-yellow-400 mb-3 sm:mb-4 drop-shadow-sm">
                {[...Array(5)].map((_, i) => (
                  <Star key={i} className="w-5 h-5 sm:w-[26px] sm:h-[26px] fill-current" />
                ))}
              </div>
              <p className="font-extrabold text-slate-800 text-sm sm:text-lg mb-1">Rated by patients in Singtam</p>
              <p className="text-[11px] sm:text-sm font-medium text-slate-500 bg-slate-50 px-3 sm:px-4 py-1.5 rounded-full mt-2 border border-slate-100">Based on online patient reviews</p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6 lg:gap-8 mb-10 sm:mb-16">
              {googleReviewsData.map((review, idx) => (
                <div key={idx} className="bg-slate-50 border border-slate-100 p-6 sm:p-8 rounded-[1.5rem] sm:rounded-3xl shadow-sm hover:shadow-[0_15px_40px_-10px_rgba(0,0,0,0.08)] hover:-translate-y-1 sm:hover:-translate-y-2 transition-all duration-500 flex flex-col h-full group relative overflow-hidden">
                  <div className="absolute top-0 right-0 w-24 h-24 sm:w-32 sm:h-32 bg-gradient-to-br from-blue-100/50 to-cyan-50/50 rounded-full blur-2xl sm:blur-3xl transform translate-x-1/2 -translate-y-1/2 pointer-events-none transition-transform duration-700 group-hover:scale-150"></div>
                  <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6 relative z-10">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-gradient-to-br from-blue-500 to-cyan-400 flex items-center justify-center text-white font-extrabold text-sm sm:text-lg shadow-inner flex-shrink-0">
                      {review.name.charAt(0).toUpperCase()}
                    </div>
                    <div>
                      <h4 className="font-bold text-slate-900 text-sm sm:text-lg leading-tight capitalize">{review.name}</h4>
                      <div className="flex text-yellow-400 mt-1 sm:mt-1.5">
                  ...
                  <p className="text-slate-600 font-medium leading-relaxed flex-grow text-xs sm:text-sm relative z-10 italic">
                    "{review.text}"
                  </p>
                </div>
              ))}
        ...
        <section className="py-16 md:py-32 bg-slate-50 relative overflow-hidden border-t border-slate-200">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16 group cursor-default">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
              ...
              {/* Badge 1 */}
              <div className="bg-white p-5 sm:p-6 md:p-8 rounded-[1.5rem] sm:rounded-[2rem] shadow-sm border border-slate-200 hover:shadow-lg hover:shadow-blue-900/5 hover:-translate-y-1 transition-all duration-500 flex flex-row items-center sm:items-start text-left group relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-blue-50/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                <div className="relative z-10 w-full flex flex-row items-center sm:items-start">
                  <div className="w-14 h-14 sm:w-16 sm:h-16 flex-shrink-0 mr-4 md:mr-6 rounded-xl sm:rounded-2xl bg-blue-50 text-blue-600 flex items-center justify-center group-hover:bg-blue-600 group-hover:text-white transition-colors duration-500 shadow-sm group-hover:scale-110 transform">
                    <ShieldCheck className="w-6 h-6 sm:w-8 sm:h-8" />
                  </div>
                  <div>
                    <h4 className="text-base sm:text-xl font-extrabold text-slate-900 mb-1 sm:mb-2 group-hover:text-blue-700 transition-colors">Government Registered</h4>
              ...
              <div className="bg-white p-5 sm:p-6 md:p-8 rounded-[1.5rem] sm:rounded-[2rem] shadow-sm border border-slate-200 hover:shadow-lg hover:shadow-blue-900/5 hover:-translate-y-1 transition-all duration-500 flex flex-row items-center sm:items-start text-left group relative overflow-hidden">
                ...
                <div className="relative z-10 w-full flex flex-row items-center sm:items-start">
                  <div className="w-14 h-14 sm:w-16 sm:h-16 flex-shrink-0 mr-4 md:mr-6 rounded-xl sm:rounded-2xl bg-emerald-50 text-emerald-600 flex items-center justify-center group-hover:bg-emerald-500 group-hover:text-white transition-colors duration-500 shadow-sm group-hover:scale-110 transform">
                    <Stethoscope className="w-6 h-6 sm:w-8 sm:h-8" />
                  </div>
                  <div>
                    <h4 className="text-base sm:text-xl font-extrabold text-slate-900 mb-1 sm:mb-2 group-hover:text-emerald-700 transition-colors">Certified Surgeon</h4>
              ...
              <div className="bg-white p-5 sm:p-6 md:p-8 rounded-[1.5rem] sm:rounded-[2rem] shadow-sm border border-slate-200 hover:shadow-lg hover:shadow-blue-900/5 hover:-translate-y-1 transition-all duration-500 flex flex-row items-center sm:items-start text-left group relative overflow-hidden">
                ...
                <div className="relative z-10 w-full flex flex-row items-center sm:items-start">
                  <div className="w-14 h-14 sm:w-16 sm:h-16 flex-shrink-0 mr-4 md:mr-6 rounded-xl sm:rounded-2xl bg-purple-50 text-purple-600 flex items-center justify-center group-hover:bg-purple-500 group-hover:text-white transition-colors duration-500 shadow-sm group-hover:scale-110 transform">
                    <Activity className="w-6 h-6 sm:w-8 sm:h-8" />
                  </div>
                  <div>
                    <h4 className="text-base sm:text-xl font-extrabold text-slate-900 mb-1 sm:mb-2 group-hover:text-purple-700 transition-colors">Modern Equipment</h4>
              ...
              <div className="bg-white p-5 sm:p-6 md:p-8 rounded-[1.5rem] sm:rounded-[2rem] shadow-sm border border-slate-200 hover:shadow-lg hover:shadow-blue-900/5 hover:-translate-y-1 transition-all duration-500 flex flex-row items-center sm:items-start text-left group relative overflow-hidden">
                ...
                <div className="relative z-10 w-full flex flex-row items-center sm:items-start">
                  <div className="w-14 h-14 sm:w-16 sm:h-16 flex-shrink-0 mr-4 md:mr-6 rounded-xl sm:rounded-2xl bg-pink-50 text-pink-600 flex items-center justify-center group-hover:bg-pink-500 group-hover:text-white transition-colors duration-500 shadow-sm group-hover:scale-110 transform">
                    <HeartHandshake className="w-6 h-6 sm:w-8 sm:h-8" />
                  </div>
                  <div>
                    <h4 className="text-base sm:text-xl font-extrabold text-slate-900 mb-1 sm:mb-2 group-hover:text-pink-700 transition-colors">Patient-First Care</h4>
        ...
        <section id="contact" className="py-16 md:py-32 bg-slate-50 relative border-t border-slate-200">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div className="bg-white rounded-[2rem] sm:rounded-[3rem] shadow-xl overflow-hidden border border-slate-200 mb-10 sm:mb-16 flex flex-col lg:flex-row">
            ...
            <div className="w-full rounded-[2rem] sm:rounded-[3rem] shadow-xl overflow-hidden border border-slate-200 bg-white flex flex-col lg:flex-row group mt-6 sm:mt-10">
